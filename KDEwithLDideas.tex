...
\newenvironment{Problem}{\LARGE \color{red} Problem:  }{\normalsize \color{black}}
...
\end{equation*}
where $\{\gamma_j\}_{j=1}^d$ are coordinate weights.
\begin{align*}
